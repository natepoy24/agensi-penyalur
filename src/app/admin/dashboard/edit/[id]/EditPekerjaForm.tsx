    ...
    <form action={formAction} className="space-y-6 bg-white p-8 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input type="text" id="nama" name="nama" required defaultValue={pekerja.nama} className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md text-slate-900" />
        </div>
        <div>
          <label htmlFor="kategori" className="block text-sm font-semibold text-slate-900">Kategori</label>
          <select id="kategori" name="kategori" required defaultValue={pekerja.kategori} className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md text-slate-900">
        ...
        <div>
          ...
          <select id="status" name="status" required defaultValue={pekerja.status} className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md text-slate-900">
        ...
        <div>
          ...
          <input type="number" id="pengalaman" name="pengalaman" required defaultValue={pekerja.pengalaman} className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md text-slate-900" />
        </div>
        <div>
          <label htmlFor="gaji" className="block text-sm font-semibold text-slate-900">Gaji (per bulan)</label>
          <input type="number" id="gaji" name="gaji" required defaultValue={pekerja.gaji || 0} className="mt-1 block w-full border rounded-md text-slate-900" />
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <textarea id="keterampilan" name="keterampilan" rows={3} defaultValue={pekerja.keterampilan || ''} className="mt-1 block w-full border rounded-md text-slate-900"></textarea>
        </div>
        <div className="md:col-span-2">
          <label htmlFor="lokasi" className="block text-sm font-semibold text-slate-900">Lokasi</label>
          <input type="text" id="lokasi" name="lokasi" required defaultValue={pekerja.lokasi} className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md text-slate-900" />
        </div>
        <div className="md:col-span-2">
          <label htmlFor="deskripsi" className="block text-sm font-semibold text-slate-900">Deskripsi</label>
          <textarea id="deskripsi" name="deskripsi" rows={4} required defaultValue={pekerja.deskripsi} className="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md text-slate-900"></textarea>
        </div>
      </div>
